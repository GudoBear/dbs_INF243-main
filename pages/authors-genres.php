...
if(isset($_POST['save_genre'])){
  ...
  try{
    $genre_id = $con->insertGenres($genre_name);
    ...
    $AddgenreCreateMessage = $e->getMessage();
  }
...
if(isset($_POST['edit_author'])){
  ...
  $UpdateAuthorCreateMessage = 'Update Author successfully.';
}catch (Exception $e){
...
if(isset($_POST['edit_genre'])){
  ...
  $UpdateGenreCreateMessage = 'Genre Updated successfully.';
}catch (Exception $e){
  $UpdateGenreCreateStatus = 'error';
  $UpdateGenreCreateMessage = $e->getMessage();
}
}
